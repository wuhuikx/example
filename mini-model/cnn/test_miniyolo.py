...
def Int8_inference(modelJit_orig, input_orig, device):
    input = input_orig.to(device)
    modelJit = modelJit_orig.to(device)
...
output_xpu = Int8_inference(modelJit, input, "xpu")
